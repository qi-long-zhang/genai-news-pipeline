...
def save_initial_tweets():
    ...
    until_time = datetime.now(timezone.utc) - timedelta(days=5)
    since_time = datetime.now(timezone.utc) - timedelta(days=14)
    ...
    while True:
        ...
        time.sleep(5)  # Wait 5 seconds between requests for free-tier rate limit
